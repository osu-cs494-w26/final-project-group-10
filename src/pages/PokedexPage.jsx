...
function SkeletonCard() {
  return (
    <div style={{ background:'var(--grey-900)', padding:'10px', borderRadius:'8px', height:'180px', display:'flex', flexDirection:'column', gap:'10px' }}>
...
export default function PokedexPage({ selectedPokemon, setSelectedPokemon, setPage, setWtpPokedexTarget, wtpPokedexTarget }) {
  ...
  const filteredPokemon = pokemon
    ...
    .sort((a, b) => {
      ...
      if (sortBy === 'highest') return pokemon.indexOf(b) - pokemon.indexOf(a);
  ...
  const handleScroll = (e) => {
    ...
    if (scrollHeight - scrollTop <= clientHeight + 100) {
      if (displayLimit < pokemon.length) setDisplayLimit(prev => prev + 24);
    }
  };
  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        {}
        <div style={{ padding:'24px 24px 16px', borderBottom:'1px solid var(--grey-800)' }}>
          <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between' }}>
            ...
            <div style={{ fontFamily:'var(--font-display)', fontSize:'28px', letterSpacing:'0.15em', textTransform:'uppercase', color:'var(--white)' }}>
              Pokédex
            </div>
        ...
        {}
        <div style={{ display:'flex', gap:'10px', flexWrap:'wrap', padding:'16px 24px' }}>
          <input
            value={search}
            ...
            style={{
              ...
              border: `1px solid ${isFocused ? 'var(--grey-300)' : 'var(--grey-500)'}`,
              background:'var(--grey-800)', fontFamily:'inherit',
          ...
          <select
            ...
            style={{
              padding:'8px 12px',
              border:`1px solid ${typeFilter ? TYPE_COLORS[typeFilter] : 'var(--grey-500)'}`,
          ...
          <select
            ...
            style={{ padding:'8px 12px', border:'1px solid var(--grey-500)', background:'var(--grey-800)', color:'white', fontSize:'14px', cursor:'pointer', fontFamily:'inherit', outline:'none' }}
          >
