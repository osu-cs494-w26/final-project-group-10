...
export default function PokedexCard({ name, data, setSelectedPokemon }) {
  ...
  return (
    ...
    >
      <span style={{ position:'absolute', top:'8px', right:'10px', fontSize:'10px', color:'var(--grey-200)' }}>
        {pokedexNumber}
      </span>
      <img
        src={data.sprite}
        ...
        {data.types.map(type => {
          ...
          return (
            <img
              ...
              src={spriteUrl}
              alt={type}
              style={{ height:'20px', marginRight:'6px', imageRendering:'pixelated', verticalAlign:'middle', marginBottom:'10px' }}
            />
          );
        })}
      </div>
